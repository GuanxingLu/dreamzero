...
class DefaultDataCollator(DataCollatorMixin):
    def __init__(self, tokenizer_path: str="/mnt/aws-lfs-02/shared/ckpts/umt5-xxl", max_length: int=512, num_views: int=1, embodiment_tag_mapping=None):
        super().__init__()
...
class DreamTransform(InvertibleModalityTransform):
    ...
    tokenizer_path: str = Field(
        default="/mnt/aws-lfs-02/shared/ckpts/umt5-xxl",
    ...
    def _prepare_video(self, data: dict):
        ...
        if images.shape[0] > 1:
            # Concatenate multiview images into a single image
            # Layout: [head, right]
            #         [left, black]
