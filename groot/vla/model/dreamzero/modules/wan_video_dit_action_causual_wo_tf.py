...
class CausalWanSelfAttention(nn.Module):
    ...
    def forward(
        ...
        if kv_cache is None:    # No cache provided, trainning mode
        ...
        else:   # Auto-regressive inference with KV cache
            ...
            if action_register_length is not None:
                ...
                raise NotImplementedError("Auto-regressive inference without action/state tokens is not implemented yet.")  
